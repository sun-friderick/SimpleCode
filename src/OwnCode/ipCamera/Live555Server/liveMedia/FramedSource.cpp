...
FramedSource::FramedSource(UsageEnvironment& env)
  ...
  liveLogInfo(" FramedSource::FramedSource \n");
}
...
Boolean FramedSource::lookupByName(UsageEnvironment& env, char const* sourceName,
  ...
  liveLogInfo(" FramedSource::lookupByName sourceName[%s] \n", sourceName);
  MediaSource* source;
...
void FramedSource::afterGetting(FramedSource* source) {
  ...
  //source->envir()  << " FramedSource::afterGetting  \n";
  liveLogInfo(" FramedSource::afterGetting  \n");
